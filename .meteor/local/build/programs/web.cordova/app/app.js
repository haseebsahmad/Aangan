...
var HomeLinks = new Mongo.Collection('homeLinks');

if (Meteor.isServer) {
  // This code only runs on the server
  Meteor.publish('homeLinks', function () {
...
module.link("history", {
  createBrowserHistory: function (v) {
...
var About = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function () {
    function render() {
      _render( /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Account, null), /*#__PURE__*/React.createElement("br", null)), document.getElementById('signin'));
...
var Account = /*#__PURE__*/function (_Component) {
  ...
  _proto.addPropertiesPopup = function () {
    function addPropertiesPopup() {
      render( /*#__PURE__*/React.createElement(Popover, {
        popover: function (_ref) {
  ...
  _proto.render = function () {
    function render() {
      ...
      if (this.props.currentUser) {
        ...
        var profile = this.props.currentUser.profile; // document.getElementById("user-role").replaceWith(requiredLink.user);
...
// import {HomeLinks} from '../api/home.js'
var Company = /*#__PURE__*/function (_Component) {
  _inheritsLoose(Company, _Component);
  ...
  _proto.renderPlots = function () {
    function renderPlots() {
      var filteredPlots = this.props.plots;
      return filteredPlots.map(function (plot) {
  ...
  _proto.renderCompanyData = function () {
    function renderCompanyData() {
      var _this = this;

      console.log("Windo id: ", window.location.pathname.match('[^/]*$')[0]);
      Meteor.call('users.companyData', window.location.pathname.match('[^/]*$')[0], function (err, result) {
        if (err) {
          console.log("Error: ", err);
        } else {
          console.log('Result Company: ', result);

          _this.refs.phone.replaceWith(result[0].phone);

          if (result[0].intro) {
            _this.refs.intro.replaceWith(result[0].intro);
          }

          if (result[0].link) {
            _this.refs.link.replaceWith(result[0].link);
          }

          _this.refs.address.replaceWith(result[0].address);
        }
      });
    }
...
var Contact = /*#__PURE__*/function (_Component) {
  _inheritsLoose(Contact, _Component);
...
var App = /*#__PURE__*/function (_Component) {
  ...
  _proto.handleSubmit = function () {
    function handleSubmit(event) {
      ...
      Meteor.call('plots.search', search, function (error, result) {
        ...
        if (result.length == 0) {
          _render( /*#__PURE__*/React.createElement("center", null, /*#__PURE__*/React.createElement("h4", null, "No Plots found")), document.getElementById('render-plots'));
        } else {
          // console.log("Price: ", result[0].price-this.refs.priceRange.value);
          _render(_this.renderPlots(result), document.getElementById('render-plots'));
        }
  ...
  _proto.renderPlots = function () {
    function renderPlots(filteredPlots) {
      return filteredPlots.map(function (plot) {
        return /*#__PURE__*/React.createElement(Plot, {
          key: plot._id,
          plot: plot
...
var Plots, UserPlotBookings;
module.link("../api/plots.js", {
  Plots: function (v) {
    Plots = v;
  },
  UserPlotBookings: function (v) {
    UserPlotBookings = v;
  }
}, 8);
var Plot;
...
var Home = /*#__PURE__*/function (_Component) {
    ...
    function handleSubmit(event) {
      ...
      Meteor.call('plots.search', search, function (error, result) {
        ...
        if (result.length == 0) {
          ...
          // console.log("Price: ", result[0].price-this.refs.priceRange.value);
          render(_this.renderPlots(result), document.getElementById('render-plots'));
  ...
  _proto.displayProperty = function () {
  ...
  _proto.renderAccounts = function () {
...
var IndividualPlot = /*#__PURE__*/function (_Component) {
  _inheritsLoose(IndividualPlot, _Component);

  function IndividualPlot(props) {
    return _Component.call(this, props) || this;
  }

  var _proto = IndividualPlot.prototype;
  ...
  _proto.renderImages = function () {
    function renderImages() {
      var _this = this;

      var images = this.props.plots[0].images;
      ...
      return images.map(function (image) {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          src: '/uploads/' + _this.props.plots[0]._id + '/' + image,
          alt: "Image placeholder",
          className: "img-fluid"
        }));
      });
...
var Login = /*#__PURE__*/function (_Component) {
    ...
    function onSubmit(event) {
      ...
      Meteor.loginWithPassword(username, password, function (error) {
        if (error) {
          ...
          _this.refs.invaliddata.replaceWith(error);
        } else {
          console.log("successful"); // window.location.pathname = '/';
        }
      });
      fetch("https://sendpk.com/api/sms.php?api_key=923229773430-d6956b96-1790-4c9b-9354-3f5f0d895901&sender=Aangan&mobile=923489773430&message=HelloWorld").then(function (result) {
  ...
  _proto.signinFacebook = function () {
...
var Plot = /*#__PURE__*/function (_Component) {
  ...
  _proto.getPhone = function () {
    function getPhone(id) {
      var _this = this;

      Meteor.call('plot.companyPhone', id, function (err, result) {
        if (result) {
          // console.log("Phone result:", result)
          _this.refs.phone.replaceWith(result);
  ...
  _proto.render = function () {
    function render() {
      ...
      if (!this.props.plot.phone) {
        var phone = this.getPhone(this.props.plot.company);
      }
...
var App = /*#__PURE__*/function (_Component) {
  ...
  _proto.createProperty = function () {
    function createProperty() {
      var today = new Date();
      var constructionDate = new Date(this.refs.constructionDate.value); //make it optional. Tbc
      ...
      if (flag == true) {
        ...
        fReader.onload = function (event) {
          ...
          Meteor.call('plots.insert', plot, event.target.result, function (error, result) {
            console.log('error: ', error);
  ...
  _proto.render = function () {
    function render() {
      _render( /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Account, null), /*#__PURE__*/React.createElement("br", null)), document.getElementById('signin')); // Download function
...
var Plot = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function () {
    function render() {
      var reviewClassName = classnames({
...
var Signup = /*#__PURE__*/function (_Component) {
  ...
  _proto.onSubmit = function () {
    function onSubmit(event) {
      ...
      if (this.refs.password.value != this.refs.passwordRepeat.value) {
        ...
        var role = "company"; //Will be chnaged when other roles are defined
        ...
        if (input.files[0]) {
          ...
          fReader.onloadend = function (event) {
            ...
            Accounts.createUser(userdata, function (error) {
              ...
              if (error) {
                ...
                _this.refs.invalidUsername.replaceWith(error.reason);
              } else {
          ...
          Accounts.createUser(userdata, function (error) {
            ...
            if (error) {
              ...
              _this2.refs.invalidUsername.replaceWith(error.reason);
            } else {
              console.log("successful", Meteor.user()._id); // redirect(role);
  ...
  _proto.addFields = function () {
    function addFields() {
      ...
      Meteor.call('user.addFields', fields, function (error, result) {
        if (error) {
          console.log("Error ", error);
        } else {
